...
class GenerationMode(ExplicitEnum):
    ...
    GREEDY_SEARCH_INFERENCE = "greedy_search_inference"
    SAMPLE = "sample"
...
class GenerationConfig(PushToHubMixin):
    ...
    def __init__(self, **kwargs):
        ...
        self.training = kwargs.pop("training", False)
            ...
            if self.do_sample is False:
                if (
                    ...
                    if self.training is True:
                        ...
                        generation_mode = GenerationMode.GREEDY_SEARCH_INFERENCE
            else:
                if self.training is True:
                    generation_mode = GenerationMode.SAMPLE
                else:
                    generation_mode = GenerationMode.SAMPLE_INFERENCE
        else:
