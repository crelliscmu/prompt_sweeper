...
LLAMA32_CONFIG = {
    ...
    "original_context_length": 131_072,
...
class ChatFormat:
    ...
    def encode_header(self, message):
        ...
        tokens.extend(self.tokenizer.encode(message["spacer"], bos=False, eos=False))
        return tokens
    ...
    def encode(self, text):
        ...
        tokens = self.encode_header(system_message)
        message = {
            "role": "user",
            "spacer": "\n\n",
            "content": text
        ...
        tokens.extend(self.encode_header(message))
        tokens.extend(
    ...
    def encode_second(self, text):
        tokens = []
        tokens.extend(self.tokenizer.encode(text, bos=False, eos=False))
        tokens.extend(self.tokenizer.encode("\n", bos=False, eos=False))
